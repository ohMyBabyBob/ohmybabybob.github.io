...
// elevator
    ...
    foot.$helper = $('#helper');
    foot.$footer = $('#footer');
    foot.$helper.offsetTop = foot.$helper.offset().top;
    foot.$helper.height = foot.$helper.height();
    ...
    foot.footerData = {
        ...
        copyright: '© 2020 meng.com All Rights Reserved'
    };

    foot.buildHelper = function (data) {
        var html = '';
    ...
    foot.buildFooter = function (data) {
        ...
        for (var i = 0; i < data.links.length; i++) {
            html += '<a href="###" target="_blank" class="footer-link">' + data.links[i] +'</a>';
        }
    ...
    foot.timeToShow = function () {
        ...
        if (lazyLoad.isVisible(foot.$helper.offsetTop, foot.$helper.height) || lazyLoad.isVisible(foot.$footer.offsetTop, foot.$footer.height)) {
            // console.log('the ' + (index + 1) + ' floor is visible');
